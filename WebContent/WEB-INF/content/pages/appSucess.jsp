...
<body>
	...
	<div class="message-green margin-top-forty">
		<h5 class="center">
			...
			Your <b>Fully customized VM </b> service has been canceled successfully.  
		</h5>
	</div>
	<div class="container padding-top-thirty margin-top-twenty displayNone">
    	<div class="row">
		...
		<div class="row">
			<div class="col-sm-4 no-padding">
				<input type="button" value="Edit Subscritption" class="btn btn-primary no-margin-top no-margin-bottom" />;
				<input type="button" value="Cancel Subscritption" class="btn btn-primary no-margin-top  margin-left-ten no-margin-bottom" />;
			</div>
			<div class="col-sm-4">
			</div>
			<div class="col-sm-4">
