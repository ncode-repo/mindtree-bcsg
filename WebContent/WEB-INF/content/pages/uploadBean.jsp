...
<body onload="msg('<%=attrib%>');">	
	<div id="site">
		...
		<div class="box6">
			<html:form  onsubmit="return validateForm()"  action="/parseBean" method="post" enctype="multipart/form-data">
				<table>
					<tr>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td align="right"><font size="2">Form</font><html:file property="theFile" styleId="file"/></td>
					</tr>
					<tr>
						<td align="right" colspan="2">
							<html:submit styleClass="button1">Upload</html:submit></td>
					</tr>
				</table>
			</html:form>
		</div>
